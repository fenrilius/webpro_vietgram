        ...
        <div class="edit-profile__container">
            <header class="edit-profile__header">
                <div class="edit-profile__avatar-container">
                    <img src="images/foto_user/arya/pp.jpg" class="edit-profile__avatar" />
                </div>
            ...
            <form action="" method="post" enctype="multipart/form-data" class="edit-profile__form">
                ...
                <div class="container" text-align ="right">
                   <button type="submit" name="submit" class="btn btn-primary center">Submit</button> 
                </div>  
