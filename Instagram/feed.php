        ...
        <div class="navigation__column">
            <ul class="navigations__links">
                ...
                <li class="navigation__list-item">
                    ...
                    <img src="images/upload.png"  width="25" height="25" />
                    </a>
                </li>
            </ul>   
        </div>
    ...
    <main id="feed">
        <?php foreach ($post as $foto):  ?>        
            ...
            <header class="photo__header">
                <img src="images/foto_user/arya/pp.jpg" class="photo__avatar" />
                <div class="photo__user-info">
                    <span class="photo__author">arya</span>
                    <span class="photo__location">Bandung</span>
                </div>
            </header>
            <img src="images/foto_user/arya/pp.jpg" />
